...
public class ArmSubsystem extends SubsystemBase {
    ...
    public enum ArmPosition {
        ...
        public double shoulderPosition() {
            switch (this) {
                ...
                case SourceShot:
                    return Constants.SHOULDER_SOURCE_SHOT_POSITION;
                case SpeakerHigh:
                ...
                case Amp2:
                    return Constants.SHOULDER_AMP_DOWN_POSITION;
                case AmpStow:
                    return Constants.SHOULDER_AMP_STOW_POSITION;
                case SubWoofer:
                ...
                case ClimberUp:
                    return Constants.SHOULDER_CLIMBER_HIGH_POSITION;
                case ClimberMid:
                    return Constants.SHOULDER_CLIMBER_MID_POSITION;
                case ClimberLow:
                    return Constants.SHOULDER_CLIMBER_LOW_POSITION;
                case ClimberStowed:
                    return Constants.SHOULDER_CLIMBER_STOWED_POSITION;
                case ClimberCompact:
        ...
        public double wristPosition() {
            switch (this) {
                ...
                case SourceShot:
                    return Constants.WRIST_SOURCE_SHOT_POSITION;
                case SpeakerHigh:
                ...
                case Amp2:
                    return Constants.WRIST_AMP_DOWN_POSITION;
                case AmpStow:
                    return Constants.WRIST_AMP_STOW_POSITION;
                case SubWoofer:
                ...
                case ClimberUp:
                    return Constants.WRIST_CLIMBER_HIGH_POSITION;
                case ClimberMid:
                    return Constants.WRIST_CLIMBER_MID_POSITION;
                case ClimberLow:
                    return Constants.WRIST_CLIMBER_LOW_POSITION;
                case ClimberStowed:
                    return Constants.WRIST_CLIMBER_STOWED_POSITION;
                case ClimberCompact:
        ...
        public double elevatorPosition() {
            switch (this) {
                ...
                case SourceShot:
                    return Constants.ELEVATOR_SOURCE_SHOT_POSITION;
                case SpeakerHigh:
                ...
                case Amp2:
                    return Constants.ELEVATOR_AMP_DOWN_POSITION;
                case AmpStow:
                    return Constants.ELEVATOR_AMP_STOW_POSITION;
                case SubWoofer:
                ...
                case ClimberUp:
                    return Constants.ELEVATOR_CLIMBER_HIGH_POSITION;
                case ClimberMid:
                    return Constants.ELEVATOR_CLIMBER_MID_POSITION;
                case ClimberLow:
                    return Constants.ELEVATOR_CLIMBER_LOW_POSITION;
                case ClimberStowed:
                    return Constants.ELEVATOR_CLIMBER_STOWED_POSITION;
                case ClimberCompact:
        ...
        public double wristMaxV() {
            switch (this) {
                ...
                case Intake:
                    return Constants.WRIST_INTAKE_MAXV;
                case Source:
                    return Constants.WRIST_SOURCE_MAXV;
                case SourceShot:
                    return Constants.WRIST_SOURCE_SHOT_MAXV;
                case SpeakerHigh:
                    return Constants.WRIST_SPEAKER_HIGH_MAXV;
                case SpeakerLow:
                    return Constants.WRIST_SPEAKER_LOW_MAXV;
                case Amp:
                    return Constants.WRIST_AMP_MAXV;
                case Amp2:
                    return Constants.WRIST_AMP_DOWN_MAXV;
                case AmpStow:
                    return Constants.WRIST_AMP_STOW_MAXV;
                case SubWoofer:
                    return Constants.WRIST_SUBWOOFER_MAXV;
                case PodiumHigh:
                    return Constants.WRIST_PODIUM_HIGH_MAXV;
                case PodiumLow:
                    return Constants.WRIST_PODIUM_LOW_MAXV;
                case ClimberUp:
                    return Constants.WRIST_CLIMBER_HIGH_MAXV;
                case ClimberMid:
                    return Constants.WRIST_CLIMBER_MID_MAXV;
                case ClimberLow:
                    return Constants.WRIST_CLIMBER_LOW_MAXV;
                case ClimberStowed:
                    return Constants.WRIST_CLIMBER_STOWED_MAXV;
                case ClimberCompact:
        ...
        public double elevatorMaxV() {
            switch (this) {
                ...
                case Intake:
                    return Constants.ELEVATOR_INTAKE_MAXV;
                case Source:
                    return Constants.ELEVATOR_SOURCE_MAXV;
                case SourceShot:
                    return Constants.ELEVATOR_SOURCE_SHOT_MAXV;
                case SpeakerHigh:
                    return Constants.ELEVATOR_SPEAKER_HIGH_MAXV;
                case SpeakerLow:
                    return Constants.ELEVATOR_SPEAKER_LOW_MAXV;
                case Amp:
                    return Constants.ELEVATOR_AMP_MAXV;
                case Amp2:
                    return Constants.ELEVATOR_AMP_DOWN_MAXV;
                case AmpStow:
                    return Constants.ELEVATOR_AMP_STOW_MAXV;
                case SubWoofer:
                    return Constants.ELEVATOR_SUBWOOFER_MAXV;
                case PodiumHigh:
                    return Constants.ELEVATOR_PODIUM_HIGH_MAXV;
                case PodiumLow:
                    return Constants.ELEVATOR_PODIUM_LOW_MAXV;
                case ClimberUp:
                    return Constants.ELEVATOR_CLIMBER_HIGH_MAXV;
                case ClimberMid:
                    return Constants.ELEVATOR_CLIMBER_MID_MAXV;
                case ClimberLow:
                    return Constants.ELEVATOR_CLIMBER_LOW_MAXV;
                case ClimberStowed:
                    return Constants.ELEVATOR_CLIMBER_STOWED_MAXV;
                case ClimberCompact:
    ...
    public ArmSubsystem() {
        ...
        wristMotor = PIDMotor.makeMotor(Constants.WRIST_MOTOR_ID, "Wrist", 0.05, 0, 0, 0, ControlType.kPosition, 150,
                1000);
        elevatorMotor = PIDMotor.makeMotor(Constants.ELEVATOR_MOTOR_ID, "Elevator", 0.06, 0, 0, 0,
                ControlType.kPosition, Constants.ELEVATOR_DEFAULT_MAXV, 500);
    ...
    public void periodic() {
        ...
        if (isTrapezoidal
                && (!leftShoulderMotor.atPosition() || !wristMotor.atPosition() || !elevatorMotor.atPosition())) {

            if (!zeroing && !percentOutZeroCheck) {
    ...
    public void safeManualLimelightSetPosition(double shoulderEncoderCount, double wristEncoderCount,
            double elevatorEncoderCount, boolean isTrapezoidal) {
